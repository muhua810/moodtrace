...
| AI 情绪分析 | 识别五级情绪类型和强度 | Workers AI 代理 + 本地 140+ 关键词 + 29 否定词 + Emoji + 分句加权 + OpenAI API 三级降级 |
...
- **AI 分析**: Workers AI 代理（DeepSeek）+ 本地关键词分析（140+ 关键词 + Emoji + 分句加权）+ OpenAI 兼容 API（可选）
